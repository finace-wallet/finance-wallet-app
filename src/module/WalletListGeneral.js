...
const WalletListGeneral = () => {
  ...
  return (
    <>
      {wallets.length > 0 ? (
        <div>
          <div class=" pl-[25px] ml-[50px] py-16">
            <div class="items-center mx-auto">
              <h1 class="text-3xl font-bold text-gray-900 mx-auto ml-7">
                My Wallets
              </h1>
              <WalletCarousel wallets={wallets} />
              <button
                onClick={() => setIsCreateWalletModalOpen(true)}
                className="px-6 py-2.5 mt-5 ml-7 text-primary font-semibold rounded-lg text-sm shadow-md bg-white hover:bg-primary hover:bg-opacity-20"
              >
                Create Wallet
              </button>
            </div>
