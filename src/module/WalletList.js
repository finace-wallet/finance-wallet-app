        ...
        <div className="relative w-5/6 mx-auto bg-white rounded-lg shadow md:w-5/6 lg:w-4/6 xl:w-3/6">
          <div className="flex justify-center">
            <img
              ...
              alt=""
              className="absolute w-32 h-32 mx-auto transition duration-200 transform border-4 border-white rounded-full shadow-md -top-20 hover:scale-110"
            />
          </div>
...
export default WalletListModule;
